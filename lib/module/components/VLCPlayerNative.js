  ...
  useImperativeHandle(ref, () => {
    ...
    return {
      ...
      setVolume: async volume => {
        ...
        console.log(`VLCPlayerNative: setVolume(${volume}) - À implémenter en Phase 1, Semaine 3`);
      },
      setMuted: async muted => {
        // TODO: Phase 1, Semaine 3 - Implémenter setMuted via props
        console.log(`VLCPlayerNative: setMuted(${muted}) - À implémenter en Phase 1, Semaine 3`);
      },
      setRate: async rate => {
        // TODO: Phase 1, Semaine 3 - Implémenter setRate via props
        console.log(`VLCPlayerNative: setRate(${rate}) - À implémenter en Phase 1, Semaine 3`);
      },
      // Pistes
      ...
      toggleFullscreen: async () => {
        ...
        console.log('VLCPlayerNative: toggleFullscreen() - À implémenter en Phase 2');
      },
      takeSnapshot: async () => {
