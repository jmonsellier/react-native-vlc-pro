...
var _TrackSelector = _interopRequireDefault(require("./TrackSelector"));
...
const VideoControlsAdvanced = ({
  ...
  const [showTrackSelector, setShowTrackSelector] = (0, _react.useState)(false);
  (0, _react.useEffect)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.Animated.View, {
  ...
  }, finalControlsConfig.showSeekButtons && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
  ...
  }, "\u23EA")), finalControlsConfig.showPlayPause && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
  ...
  }, isPlaying ? '⏸️' : '▶️')), finalControlsConfig.showSeekButtons && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    style: styles.controlButton,
    ...
    style: styles.controlButtonText
  }, "\u23E9")), finalControlsConfig.showVolumeControl && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    style: styles.controlButton,
    ...
    style: styles.controlButtonText
  }, isMuted ? '🔇' : volume > 50 ? '🔊' : '🔉')), finalControlsConfig.showRateSelector && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    style: styles.controlButton,
    ...
    style: styles.controlButtonText
  }, playbackRate, "x")), finalControlsConfig.showTrackSelector && (audioTracks.length > 0 || subtitleTracks.length > 0) && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    style: styles.controlButton,
    ...
    style: styles.controlButtonText
  }, "\uD83C\uDFB5")), finalControlsConfig.showFullscreenButton && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    style: styles.controlButton,
    ...
    style: styles.controlButtonText
  }, isFullscreen ? '⛶' : '⛶'))), showVolumeSlider && finalControlsConfig.showVolumeControl && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  }, isMuted ? 0 : volume, "%")), showRateSelector && finalControlsConfig.showRateSelector && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  }, rate, "x")))), /*#__PURE__*/_react.default.createElement(_TrackSelector.default, {
...
var _default = exports.default = VideoControlsAdvanced;
